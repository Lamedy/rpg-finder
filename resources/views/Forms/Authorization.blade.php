    ...
    <form action="{{ route('login.submit') }}" method="POST">
        ...
        <div class="max-w-2xl mx-auto rounded-md overflow-hidden shadow-lg border border-black">
            ...
            <div class="bg-gray-200 p-6 space-y-4">
                <div>
                    ...
                    <input type="text" id="login" name="login" required
                           class="font-alegreya_medium w-full px-4 py-2 rounded-md border border-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400">
                    @error('login')
                ...
                <div class="text-right text-sm font-alegreya_medium text-gray-700 underline hover:text-black cursor-pointer">
            ...
            <div class="bg-[#2D2D2D] p-4 flex justify-center space-x-4">
                ...
                <button class="bg-white font-alegreya_bold px-5 py-2 rounded hover:bg-[#828282] transition w-60">
                    Войти
                </button>
            </div>
        </div>
